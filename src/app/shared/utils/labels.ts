...
const NOTIFICACION_ACCION_LABELS: Record<string, string> = {
  ...
  abono_excedente: 'Un corte recibió más dinero del que se debía — se guardó como saldo a favor y se aplicará solo al siguiente corte',
  excedente_generado: 'Pagaste de más en un corte — el excedente quedó como saldo a tu favor',
  excedente_aplicado: 'Se aplicó tu saldo a favor a un corte nuevo',
  reembolso_excedente_solicitado: 'La cajera solicitó el reembolso del saldo a favor de un vale ya liquidado — requiere tu decisión',
  reembolso_excedente_aprobado: 'Se aprobó el reembolso de un saldo a favor',
  reembolso_excedente_rechazado: 'Se rechazó el reembolso de un saldo a favor',
